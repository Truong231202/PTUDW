...
namespace WebApplication2.Controllers
{
    ...
    {
        private QuanLiNhanVienEntities1 db = new QuanLiNhanVienEntities1();
        ...
        {
            List<NhanVien> list = db.NhanViens.Where(m => m.tenNhanVien.ToLower().Contains(filter.ToLower()) == true).ToList();
            if(list.Count == 0)
            {
                ViewBag.Count = db.NhanViens.Count();
